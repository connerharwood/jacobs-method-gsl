...
sample_rast = rast("Data/Raw/OpenET/eeMETRIC/utah_eemetric_2024_10.tif")

# Load 2024 fields
fields_sf = st_read("Data/Clean/fields_panel.gpkg") |> 
...
for (year in 2016:2024) {
  ...
  for (month in months) {
    ...
    openet_rast = rast(glue("Data/Raw/OpenET/eeMETRIC/utah_eemetric_{year}_{month}.tif"))
...
save(openet_eemetric, file = "Data/Clean/openet_eemetric.rda")
