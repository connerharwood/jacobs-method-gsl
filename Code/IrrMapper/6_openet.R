...
# Load 2024 fields
fields_sf = st_read("Data/IrrMapper/Utah/fields_irrmapper_panel_final.gpkg") |> 
...
for (year in 2016:2024) {
  ...
  for (month in months) {
    ...
    openet_rast = rast(glue("Data/Raw/OpenET/Utah/eeMETRIC/utah_eemetric_{year}_{month}.tif"))
...
save(openet_eemetric, file = "Data/IrrMapper/Utah/openet_eemetric.rda")
