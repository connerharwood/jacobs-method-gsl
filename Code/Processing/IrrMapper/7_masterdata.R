...
load("Data/IrrMapper/Utah/ssurgo.rda") # Soil data
load("Data/IrrMapper/Utah/prism.rda") # Monthly precipitation data
load("Data/IrrMapper/Utah/openet_eemetric.rda") # Monthly ET data
...
save(masterdata, file = "Data/IrrMapper/Utah/masterdata.rda")
