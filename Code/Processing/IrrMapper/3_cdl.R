...
sample_rast = rast("Data/Raw/CDL/Utah/CDL_2024_49.tif")

# Load temporary fields panel
fields_panel_temp = st_read("Data/IrrMapper/Utah/fields_irrmapper_panel.gpkg") |> 
...
tiff_files = list.files("Data/Raw/CDL/Utah", full.names = TRUE)
...
st_write(fields_panel, "Data/IrrMapper/Utah/fields_irrmapper_panel_final.gpkg", delete_layer = TRUE)
